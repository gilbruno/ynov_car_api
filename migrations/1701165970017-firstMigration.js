...
module.exports = class FirstMigration1701165970017 {
    name = 'FirstMigration1701165970017'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (1), "name" varchar NOT NULL DEFAULT (''))`);
